...
class DiagnosaController extends Controller
{
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('B3', 'Id Penyakit');
        $sheet->setCellValue('C3', 'Id Pertanyaan');
        $sheet->setCellValue('D3', 'Id Pasien');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data Diagnosa');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('B' . $row, $data->id_penyakit);
            $sheet->setCellValue('C' . $row, $data->id_pertanyaan);
            $sheet->setCellValue('D' . $row, $data->id_pasien);
